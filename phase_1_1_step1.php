...
<div class="w3-container w3-margin-top w3-large w3-mobile">
	...
	<div class="w3-row">
	  <div class="w3-col w3-container w3-xxlarge"><h1 style="color: yellow;">階段一 - 步驟一 : 確認主題和目的</a></h1></div>
	</div>
	<div class="w3-row">
	  <div class="w3-col w3-container">
		...
		<p>1) 我的故事主題是什麼?</p>
		<p>2)「為什麼」選擇它作為故事的中心點?想傳達什麼理念?或是故事想要解決什麼問題?</p>
		<p>3) 故事是否帶給觀眾教育的價值？</p>
...
<?php foreach ( $theme as $row ) : ?>
	  ...
	  <div class="w3-col w3-container w3-quarter"><a href="phase_1_1_step1_edit.php?id=<?= $row["id"]; ?>" class="w3-button w3-section w3-green w3-ripple"><i class='fas fa-edit' style='font-size:24px'></i></a><a href="phase_1_1_step1_delete.php?id=<?= $row["id"]; ?>" onclick="return confirm('Do you want to delete?');" class="w3-button w3-section w3-green w3-ripple"><i class='fas fa-trash-alt' style='font-size:24px'></i></a></div>
	</div>
