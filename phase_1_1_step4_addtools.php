...
if ( isset($_POST["submit"]) ) {
  ...
  if ( tambahtools($_POST) > 0 ) {
    echo "
      <script>
      alert('Your tools has been added!');
    ...
    echo "
      <script>
      alert('Sorry, your tools didn't added!');
      document.location.href = 'phase_1_1_step4.php';
      </script>
    ";
  }
...
<div class="w3-container w3-margin-top w3-large w3-mobile">
	...
	<div class="w3-row">
	  <div class="w3-col w3-container w3-xxlarge"><h1>階段一 - 步驟四: 確認PBL討論框架</h1></div>
	</div>
	<div class="w3-row">
	    <div class="w3-col w3-container"><p>請在此寫下你的答案</div>
        <div class="w3-col w3-container"><p>想法-問題應該如何解決？</div>
        <div class="w3-col w3-container"><p>事實-知道什麼問題相關的事實？</div>
        <div class="w3-col w3-container"><p>學習論題-要解決問題還需要知道什麼？</div>
        <div class="w3-col w3-container"><p>行動計畫-如何尋找解決問題方法的資料？</div>
	</div>
	
	<form action="" class="w3-container w3-lime" enctype="multipart/form-data" method="POST">
	<div class="container">
        <div class="comment">
            <textarea class="textinput" rows="10" placeholder="Add your new tools here" type="text" name="nama"></textarea>
