...
if ( isset($_POST["submit"]) ) {
  ...
  if ( purpose_desc($_POST) > 0 ) {
    ...
    echo "
      <script>
      alert('Your purpose didn't saved.');
      //document.location.href = 'phase_1_3_purp.php';
      </script>
    ";
  }
...
<div class="w3-container w3-margin-top w3-large w3-mobile">
	...
	<div class="w3-row">
	  <div class="w3-col w3-container w3-xxlarge"><h1>Phase 1 - Step 2 : Confirm the purpose of  your digital storytelling</h1></div>
	</div>
	<div class="w3-row">
	  <div class="w3-col w3-container"><p>What’s the story you want to tell? What do you think your story means? Is the theme related to the educational theory?</p>
    </div>
	</div>
	...
	<div class="container">
        <div class="comment">
            ...
            <textarea class="textinput" placeholder="Describe your purpose here" type="textarea" name="nama" required></textarea>
        </div>
    </div>
