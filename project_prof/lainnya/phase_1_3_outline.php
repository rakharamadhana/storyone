...
if ( isset($_POST["submit"]) ) {
  ...
  if ( outline_desc($_POST) > 0 ) {
    echo "
      <script>
      alert('Your outline has been saved.');
    ...
    echo "
      <script>
      alert('Your outline didn't saved.');
...
<div class="w3-container w3-margin-top w3-large w3-mobile">
	...
	<div class="w3-row">
	  <div class="w3-col w3-container w3-xxlarge"><h1>Phase 1 - Step 3 : Confirm the outline of your digital storytelling</h1></div>
	</div>
	<div class="w3-row">
	  <div class="w3-col w3-container"><p>Please write down the outline of your digital storytelling</p>
    </div>
	</div>
	...
	<div class="container">
        <div class="comment">
            ...
            <textarea class="textinput" placeholder="Describe your outline here" type="textarea" name="nama" required></textarea>
        </div>
    </div>
