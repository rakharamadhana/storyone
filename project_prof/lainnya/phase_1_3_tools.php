...
if ( isset($_POST["submit"]) ) {
  ...
  if ( tools_desc($_POST) > 0 ) {
    echo "
      <script>
      alert('Your way of digital presentation and tools has been saved.');
      document.location.href = 'phase_1_1.php';
      </script>
    ";
  } else {
    echo "
      <script>
      alert('Your way of digital presentation and tools didn't saved.');
      //document.location.href = 'phase_1_3_outline.php';
      </script>
    ";
  }
...
<div class="w3-container w3-margin-top w3-large w3-mobile">
	...
	<div class="w3-row">
	  <div class="w3-col w3-container w3-xxlarge"><h1>Phase 1 - Step 4 : Confirm the way of digital presentation and tools</h1></div>
	</div>
	<div class="w3-row">
	  <div class="w3-col w3-container"><p>Please write down the way of digital presentation and tools of your digital storytelling</p>
    </div>
	</div>
	...
	<div class="container">
        <div class="comment">
            ...
            <textarea class="textinput" placeholder="Describe your ways here" type="textarea" name="nama" required></textarea>
        </div>
    </div>
