...
if ( isset($_POST["submit"]) ) {
  ...
  if ( presentation($_POST) > 0 ) {
    ...
    echo "
      <script>
      alert('Your presentation didn't saved.');
      //document.location.href = 'phase_3_1.php';
      </script>
    ";
  }
...
<div class="w3-container w3-margin-top w3-large w3-mobile">
	...
	<div class="w3-row">
	  <div class="w3-col w3-container w3-xxlarge"><h1>Phase 3 - Reflection and Discussion (Presentation)</h1></div>
	</div>
	<div class="w3-row">
	  <div class="w3-col w3-container"><p>Please write your presentation about your storytelling here</p>
    </div>
	</div>
	...
	<div class="container">
        <div class="comment">
            ...
            <textarea class="textinput" placeholder="Describe your presentation here" type="textarea" name="nama" required></textarea>
        </div>
    </div>
