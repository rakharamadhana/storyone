...
if ( isset($_POST["submit"]) ) {
  ...
  if ( theme_desc($_POST) > 0 ) {
    echo "
      <script>
      alert('Your theme description has been saved.');
    ...
    echo "
      <script>
      alert('Your theme description didn't saved.');
...
<div class="w3-container w3-margin-top w3-large w3-mobile">
	...
	<div class="w3-row">
	  <div class="w3-col w3-container"><p>Please write down the reasons why you choose your presentation and your ideal techniques</p>
    </div>
	</div>
	...
	<div class="container">
        <div class="comment">
            ...
            <textarea class="textinput" placeholder="Describe your reasons here" type="textarea" name="nama" required></textarea>
        </div>
    </div>
