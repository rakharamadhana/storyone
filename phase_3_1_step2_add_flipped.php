...
if ( isset($_POST["submit"]) ) {
  ...
  if ( tambahreflect2($_POST) > 0 ) {
    echo "
      <script>
      alert('Your reflection has been added!');
    ...
    echo "
      <script>
      alert('Sorry, your reflection didn't added!');
      document.location.href = 'phase_3_1_step2_flipped.php';
      </script>
    ";
  }
...
<div class="w3-container w3-margin-top w3-large w3-mobile">
	...
	<div class="w3-row">
	  <div class="w3-col w3-container w3-xxlarge"><h1>Phase 3 - Part 2 : Add your reflection</h1></div>
	</div>
	<div class="w3-row">
	  <div class="w3-col w3-container"><p>Please write your reflection here
	...
	<div class="container">
        <div class="comment">
            <textarea class="textinput" placeholder="Add your new reflection here" type="text" name="nama"></textarea>
