...
$reflect = query("SELECT * FROM reflect WHERE user = '$userid' ORDER BY pilih ASC");
...
<div class="w3-container w3-margin-top w3-large w3-mobile">
	...
	<div class="w3-row">
	  <div class="w3-col w3-container w3-xxlarge"><h1>Phase 3 - Part 1 : Reflection and discussion</a></h1></div>
	</div>
	<div class="w3-row">
	  <div class="w3-col w3-container"><p>This is the first reflection and discussion of your storytelling</p></div>
	</div>

<!-- Looping for the div table -->
<?php $i = 1; ?>	
<?php foreach ( $reflect as $row ) : ?>
	  ...
	  <div class="w3-col w3-container w3-quarter"><a href="phase_3_1_step1_edit_flipped.php?id=<?= $row["id"]; ?>" class="w3-button w3-section w3-green w3-ripple"><i class='far fa-edit' style='font-size:24px'></i></a><a href="phase_3_1_step1_delete_flipped.php?id=<?= $row["id"]; ?>" onclick="return confirm('Do you want to delete?');" class="w3-button w3-section w3-green w3-ripple"><i class='far fa-trash-alt' style='font-size:24px'></i></a></div>
	</div>
...
<!-- End looping for the div table -->
	...
	<div class="w3-row">
		...
		<a href="phase_3_1_step1_add_flipped.php" class="w3-button w3-section w3-green w3-ripple">Add reflection</a> <!-- <a href="phase_3_1_step1_changeorder_flipped.php" class="w3-button w3-section w3-green w3-ripple">Change order</a>--> &nbsp<a href="phase_3_1.php" class="w3-button w3-section w3-green w3-ripple"><i class='fas fa-undo'></i></a></div>
	</div> 
</div>
