...
$design = query("SELECT * FROM design WHERE user = '".$_SESSION["userId"]."'");
...
$query = "SELECT * FROM design WHERE user = '".$_SESSION["userId"]."' ORDER BY page_order ASC";
...
<div class="w3-container w3-margin-top w3-large w3-mobile">
	...
	<div class="w3-row">
	  <div class="w3-col w3-container w3-xxlarge"><h1>階段二: 改變腳本的順序</a></h1></div>
	</div>
	<div class="w3-row"><br>
	  <div class="w3-col w3-container"><p>你可以隨意拖曳腳本的順序.</p></div>
	</div>
...
<div style="color: black;">
   ...
   {
    echo '<li id="'.$row["id"].'">'.$row["keterangan"].'</li>';
   }
   ?>
   </ul>
...
<div class="w3-col w3-container">
    <a href="phase_2_1.php" class="w3-button w3-section w3-green w3-ripple" style="text-decoration: none;"><i class='fas fa-undo'></i></a></div>
</div>
