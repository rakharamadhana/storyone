...
$peer = query("SELECT * FROM peer_reflection WHERE user = '$userid' ORDER BY id ASC");
...
<!-- End Nama yang di comments -->
	  ...
	  <div class="w3-col w3-container w3-quarter"><a href="phase_3_1_peeredit.php?id=<?= $row["id"]; ?>" class="w3-button w3-section w3-green w3-ripple"><i class='far fa-edit' style='font-size:24px'></i></a><a href="phase_3_1_peerdelete.php?id=<?= $row["id"]; ?>" onclick="return confirm('Do you want to delete?');" class="w3-button w3-section w3-green w3-ripple"><i class='far fa-trash-alt' style='font-size:24px'></i></a></div>
	</div>
...
<!-- End looping for the div table -->
	...
	<div class="w3-row">
		...
		<a href="phase_3_1_peerreflection.php" class="w3-button w3-section w3-green w3-ripple"><i class='fas fa-undo'></i></a></div>
	</div> 
</div>
