...
if ( isset($_POST["submit"]) ) {
  ...
  if ( tambahtheme($_POST) > 0 ) {
    echo "
      <script>
      alert('Your theme has been added!');
    ...
    echo "
      <script>
      alert('Sorry, your theme didn't added!');
      document.location.href = 'phase_1_1_step1.php';
      </script>
    ";
  }
...
<div class="w3-container w3-margin-top w3-large w3-mobile">
	...
	<div class="w3-row">
	  <div class="w3-col w3-container w3-xxlarge"><h1>階段一 - 步驟一 : 確認主題</h1></div>
	</div>
	<div class="w3-row">
	  <div class="w3-col w3-container"><p>請在此寫下你的主題名稱，於儲存後點選 Reason 1 (原因一：針對第一次主題寫下說明)完成此任務。
	...
	<div class="container">
        <div class="comment">
            <textarea class="textinput" placeholder="Add your new theme here" type="text" name="nama"></textarea>
