...
$dataku = query("SELECT * FROM design WHERE id=$id")[0]; 
// var_dump($mhs[0]["nama"]);
...
<div class="w3-container w3-margin-top w3-large w3-mobile">
	...
	<div class="w3-row">
	  <div class="w3-col w3-container w3-xxlarge"><h1>階段二 - 階段修改: 修改我的自我檢核</h1></div>
	</div>
	<div class="w3-row">
	  <div class="w3-col w3-container"><p>編輯自我檢核
	...
	<div class="container">
        <div class="comment">
            ...
            <textarea name="keterangan" class="textinput" rows="10" cols="10" wrap="hard" style="overflow:hidden; resize:none; margin-top:15px; overflow-y: scroll;"><?= $dataku["keterangan"]; ?></textarea>
            <!--<input class="textinput" type="text" name="keterangan" value="<?= $dataku["keterangan"]; ?>">-->
            <input type="hidden" name="user" value="<?= $dataku["user"]; ?>">
            <input type="hidden" name="page_order" value="<?= $dataku["page_order"]; ?>">
        </div>
    </div>
