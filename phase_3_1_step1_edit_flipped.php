...
$dataku = query("SELECT * FROM reflect WHERE id=$id")[0]; 
// var_dump($mhs[0]["nama"]);
...
<div class="w3-container w3-margin-top w3-large w3-mobile">
	...
	<div class="w3-row">
	  <div class="w3-col w3-container w3-xxlarge"><h1>Phase 3 - Reflection 1 : Revise the reflection</h1></div>
	</div>
	<div class="w3-row">
