...
$theme = query("SELECT * FROM theme_reason WHERE user = '$userid' ORDER BY pilih ASC");
...
<div class="w3-container w3-margin-top w3-large w3-mobile">
	...
	<div class="w3-row">
	  <div class="w3-col w3-container w3-xxlarge"><h1>原因一: 為什麼你會選擇這個主題及想傳達的故事目的
</a></h1></div>
	</div>
	<div class="w3-row">
	  <div class="w3-col w3-container"><p>
		此步驟是解釋<span style="color: yellow;">〝第一次〞</span>構想數位敘事主題的地方，請寫下「為什麼」選擇它作為故事的中心點?想傳達什麼理念?或是故事想要解決什麼問題?以及故事是否帶給觀眾教育的價值?
		</p>
		</div>
	</div>
...
<?php foreach ( $theme as $row ) : ?>
	  ...
	  <div class="w3-col w3-container w3-quarter"><a href="phase_1_1_step1b_edit.php?id=<?= $row["id"]; ?>" class="w3-button w3-section w3-green w3-ripple"><i class='fas fa-edit' style='font-size:24px'></i></a><a href="phase_1_1_step1b_delete.php?id=<?= $row["id"]; ?>" onclick="return confirm('Do you want to delete?');" class="w3-button w3-section w3-green w3-ripple"><i class='fas fa-trash-alt' style='font-size:24px'></i></a></div>
	</div>
...
<!-- End looping for the div table -->
	...
	<div class="w3-row">
		...
		<a href="phase_1_1_step1b_addreason.php" class="w3-button w3-section w3-green w3-ripple">Add reason (新增原因)</a><!-- <a href="phase_1_1_step1b_changeorder.php" class="w3-button w3-section w3-green w3-ripple">Change order</a> -->&nbsp<a href="phase_1_1_step1.php" class="w3-button w3-section w3-green w3-ripple"><i class='fas fa-undo'></i></a></div>
	</div> 
</div>
