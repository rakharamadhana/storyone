...
$themeku = query("SELECT * FROM theme WHERE user = '$userid' ORDER BY pilih ASC");
...
<div class="w3-container w3-margin-top w3-large w3-mobile">
	...
	<div class="w3-row">
	  <div class="w3-col w3-container w3-xxlarge"><h1>Phase 1 - Step 1 : Confirm the theme of your digital storytelling</a></h1></div>
	</div>
	<div class="w3-row">
...
<?php foreach ( $themeku as $row ) : ?>
		...
		<?php endif; ?>
		<!-- End div -->
	  <div class="w3-col w3-container w3-xxlarge w3-quarter"><h1>Section <?= $i; ?> :</h1></div>
	  <div class="w3-col w3-container w3-half"><p><?= $row["nama"]; ?></p></div>
	  <div class="w3-col w3-container w3-quarter"><a href="phase_2_3.php?id=<?= $row["id"]; ?>" class="w3-button w3-section w3-green w3-ripple"><i class='far fa-edit' style='font-size:24px'></i></a><a href="delete_theme.php?id=<?= $row["id"]; ?>" onclick="return confirm('Do you want to delete this scipt design?');" class="w3-button w3-section w3-green w3-ripple"><i class='far fa-trash-alt' style='font-size:24px'></i></a></div>
	</div>
...
<!-- End looping for the div table -->
	...
	<div class="w3-row">
		...
		<a href="phase_2_2.php" class="w3-button w3-section w3-green w3-ripple">Add script</a><a href="phase_2_1_uporder.php" class="w3-button w3-section w3-green w3-ripple">Change order</a></div>
	</div> 
</div>
