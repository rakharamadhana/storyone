...
if ( isset($_POST["submit"]) ) {
  ...
  if ( tambahpresentation($_POST) > 0 ) {
    ...
    echo "
      <script>
      alert('Sorry, your presentation didn't added!');
      document.location.href = 'phase_3_2_present.php';
      </script>
    ";
  }
...
<div class="w3-container w3-margin-top w3-large w3-mobile">
	...
	<div class="w3-row">
	  <div class="w3-col w3-container w3-xxlarge"><h1>Phase 3 : Add your reflection of presentation</h1></div>
	</div>
	<div class="w3-row">
	  <div class="w3-col w3-container"><p>Please write your reflection of presentation here
