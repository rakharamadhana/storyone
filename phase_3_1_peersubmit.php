...
if ( isset($_POST["submit"]) ) {
  ...
  if ( tambahreflection($_POST) > 0 ) {
    echo "
      <script>
      alert('Your data has been added!');
      document.location.href = 'phase_3_1_peerreflection.php';
      </script>
    ";
  } else {
    echo "
...
<div class="w3-container w3-margin-top w3-large w3-mobile">
	...
	<div class="w3-row">
	  <div class="w3-col w3-container"><p>請根據同儕的<span style="color:yellow;">故事內容呈現，</span>並在下方給予適當的評論或建議
...
<!-- Awal konten -->
  ...
  <div class="w3-row w3-lime">
    ...
    <p><span style="font-size: 30px;"><i class='fas fa-caret-right'></i> 確認PBL討論框架 :</span> <br>
  ...
  <div class="w3-row w3-lime">
    <div class="w3-col w3-container w3-rest">
    <p>請給他人的 <span style="color: red;">故事腳本呈現</span> 適合的建議：</p>
    <p>(1.)對於這組的故事腳本，最令你印象深刻的地方是哪個部分?為什麼?</p>
    <p>(2.)欣賞完這組的故事腳本，我覺得很棒的地方是...?</p>
    <p>(3.)欣賞完這組的故事腳本，我覺得可以改善的地方是...?為什麼?</p>
  </div>
