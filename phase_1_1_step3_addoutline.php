...
if ( isset($_POST["submit"]) ) {
  ...
  if ( tambahoutline($_POST) > 0 ) {
    echo "
      <script>
      alert('Your outline has been added!');
    ...
    echo "
      <script>
      alert('Sorry, your outline didn't added!');
      document.location.href = 'phase_1_1_step3.php';
      </script>
    ";
  }
...
<div class="w3-container w3-margin-top w3-large w3-mobile">
	...
	<div class="w3-row">
	  <div class="w3-col w3-container w3-xxlarge"><h1>階段一 - 步驟三: 新增我的故事大綱</h1></div>
	</div>
	<div class="w3-row">
	  <div class="w3-col w3-container"><p>此步驟是說明數位敘事<span style="color: yellow;">〝大綱〞</span>的地方，需要包含主線和最精彩的地方。<p>

      <p>1) 故事中將出現哪些人物、時間、地點？</p>
      <p>2) 我的故事大綱起(發生什麼事)承(面對的問題)轉(如何解決)合(結局)是什麼?</p>
      <p>3) 故事帶給讀者什麼影響?</p>
	...
	<div class="container">
        <div class="comment">
            <textarea class="textinput" rows="10" placeholder="Add your new outline here" type="text" name="nama"></textarea>
