...
<ul id="messages" class="w3-panel w3-border-0" style="font-family: Raleway; background-color: white; width:100%; ">
	<li>loading…</li>
</ul>

<form action="<?= htmlentities($_SERVER['PHP_SELF'], ENT_COMPAT, 'UTF-8'); ?>" method="post">
	<p>
		<input class="w3-input" type="text" name="content" id="content" placeholder="閒聊" style="width:100%;" required>
	</p>
	<p>
		<label>
			Name (名稱):
			<input class="w3-input" type="text" name="name" id="name" placeholder="your name" required>
		</label>
		<button type="submit" class="w3-button w3-section w3-green w3-ripple">Send (寄)</button>
	</p>
</form>
<!--
