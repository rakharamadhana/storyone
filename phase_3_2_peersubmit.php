...
if ( isset($_POST["submit"]) ) {
  ...
  if ( tambahreflection2($_POST) > 0 ) {
    echo "
      <script>
      alert('Your data has been added!');
      document.location.href = 'phase_3_2_peerreflection.php';
      </script>
    ";
  } else {
    echo "
...
<div class="w3-container w3-margin-top w3-large w3-mobile">
    ...
    請給他人 <span style="color:yellow;">報告的數位敘事 case study </span>適合的建議
...
<!-- Awal konten -->
  ...
  <div class="w3-row w3-lime">
    ...
    <div class="w3-col w3-container w3-rest">
      <p>請給他人的 <span style="color:red; font-weight: bold;">case study</span> 適合的建議：<br>
      (1.) 最令你印象深刻或是很棒的地方是什麼?為什麼?<br>
      (2.) 欣賞完他的 case study，你覺得可以改進的地方是...?<br>
      (3.) 欣賞完他的 case study，你有什麼啟發或反思，或是想要更了解的地方是...?
      </p>
    </div>
