...
<div class="w3-container w3-margin-top w3-large w3-mobile">
	...
	<div class="w3-row">
	  <div class="w3-col w3-container w3-xxlarge"><h1>Edit the user of Digital Storytelling</h1></div>
	</div>
	<div class="w3-row">
	  <div class="w3-col w3-container"><p>You can edit the user password
  ...
  <input class="w3-input" type="text" style="width:100%" name="username" value="<?= $dataku["username"]; ?>" required>
  </p>
            <p>
