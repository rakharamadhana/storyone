...
<div class="w3-container w3-margin-top w3-large w3-mobile">
	...
	<div class="w3-row">
	  <div class="w3-col w3-container w3-xxlarge"><h1>Give informations or instructions to the students</a></h1></div>
	</div>
	<div class="w3-row">
	  <div class="w3-col w3-container"><p>You can give some informations to the students</p></div>
	</div>
...
<?php foreach ( $info as $row ) : ?>
		...
		<?php endif; ?>
		<!-- End div -->
	  <div class="w3-col w3-container w3-xxlarge w3-quarter"><h1>Info <!-- <?= $i; ?> --> :</h1></div>
	  <div class="w3-col w3-container w3-half"><p><?= $row["informasi"]; ?></p></div>
	  <div class="w3-col w3-container w3-quarter"><a href="three_edit.php?id=<?= $row["id"]; ?>" class="w3-button w3-section w3-green w3-ripple"><i class='far fa-edit' style='font-size:24px'></i></a><a href="three_delete.php?id=<?= $row["id"]; ?>" onclick="return confirm('Do you want to delete?');" class="w3-button w3-section w3-green w3-ripple"><i class='far fa-trash-alt' style='font-size:24px'></i></a></div>
	</div>
...
<!-- End looping for the div table -->
	...
	<div class="w3-row">
		...
		<a href="three_add.php" class="w3-button w3-section w3-green w3-ripple">Add information</a> <!-- <a href="phase_3_1_step1_changeorder_flipped.php" class="w3-button w3-section w3-green w3-ripple">Change order</a>--> &nbsp<a href="menu.php" class="w3-button w3-section w3-green w3-ripple"><i class='fas fa-undo'></i></a></div>
	</div> 
</div>
