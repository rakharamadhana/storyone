...
<div class="w3-container w3-margin-top w3-large w3-mobile">
	...
	<div class="w3-row">
	  <div class="w3-col w3-container w3-xxlarge"><h1>Check the results of Digital Storytelling</h1></div>
	</div>
	<div class="w3-row">
	  <div class="w3-col w3-container"><p>You can see and download the results (excel file .xls)</p></div>
	</div>
...
<?php foreach ( $username as $row ) : ?>
	  ...
	  <div class="w3-col w3-container w3-quarter"><a href="two_comments.php?id=<?= $row["id"]; ?>" class="w3-button w3-section w3-green w3-ripple"><i class='far fa-file-alt' style='font-size:24px'></i></a><a href="two_excel.php?id=<?= $row["id"]; ?>" class="w3-button w3-section w3-green w3-ripple"><i class='fa fa-cloud-download' style='font-size:24px'></i></a></div>
	</div>
