...
$dataku = query("SELECT * FROM info_admin WHERE id=$id")[0]; 
// var_dump($mhs[0]["nama"]);
...
<div class="w3-container w3-margin-top w3-large w3-mobile">
	...
	<div class="w3-row">
	  <div class="w3-col w3-container w3-xxlarge"><h1>Edit your information or instructions </h1></div>
	</div>
	<div class="w3-row">
	  <div class="w3-col w3-container"><p>You can edit your informations and instructions to students
	...
	<div class="container">
        <div class="comment">
            ...
            <!--<input class="textinput" type="text" name="informasi" value="<?= $dataku["informasi"]; ?>"> -->
            <textarea name="informasi" class="textinput" rows="3" cols="10" wrap="hard" style="overflow:hidden; resize:none; margin-top:15px; overflow-y: scroll;"><?= $dataku["informasi"]; ?></textarea>
        </div>
    </div>
