...
<div class="w3-container w3-margin-top w3-large w3-mobile">
	...
	<div class="w3-row">
	  <div class="w3-col w3-container w3-xxlarge"><h1>修改原因</h1></div>
	</div>
	<div class="w3-row">
	  <div class="w3-col w3-container"><p>你可以編輯自己的原因
	...
	<div class="container">
        <div class="comment">
            ...
            <textarea name="nama" class="textinput" rows="2" cols="10" wrap="hard" style="overflow:hidden; resize:none; margin-top:15px; overflow-y: scroll;"><?= $dataku["nama"]; ?></textarea>
            <!--<input class="textinput" type="text" name="reason" value="<?= $dataku["reason"]; ?>" style="margin-top: 10px;">-->
            <textarea name="reason" class="textinput" rows="10" cols="10" wrap="hard" style="overflow:hidden; resize:none; margin-top:15px; overflow-y: scroll;"><?= $dataku["reason"]; ?></textarea>
