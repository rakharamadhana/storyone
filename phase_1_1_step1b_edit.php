...
$dataku = query("SELECT * FROM theme_reason WHERE id=$id")[0]; 
// var_dump($mhs[0]["nama"]);
...
<div class="w3-container w3-margin-top w3-large w3-mobile">
	...
	<div class="w3-row">
	  <div class="w3-col w3-container w3-xxlarge"><h1>階段一 步驟一 修改編輯我的原因一</h1></div>
	</div>
	<div class="w3-row">
	  <div class="w3-col w3-container"><p>你可以隨時編輯自己的原因(故事目的)
