...
$dataku = query("SELECT * FROM group_diss WHERE id=$id")[0]; 
// var_dump($mhs[0]["nama"]);
...
<div class="w3-container w3-margin-top w3-large w3-mobile">
	...
	<div class="w3-row">
	  <div class="w3-col w3-container w3-xxlarge"><h1>階段三:修改小組討論內容</h1></div>
	</div>
	<div class="w3-row">
	  <div class="w3-col w3-container"><p>你可以在此編輯小組討論內容
	...
	<div>
        <div class="comment">
            ...
            <h3>Group name (隊名) :</h3>  <input class="text" type="text" name="group_name" value="<?= $dataku["group_name"]; ?>">
            <!-- <input class="textinput" type="text" name="nama" value="<?= $dataku["nama"]; ?>" style="margin-top: 10px;">-->
            ...
            <input type="hidden" name="user2" value="<?= $dataku["user2"]; ?>">
            <input type="hidden" name="user3" value="<?= $dataku["user3"]; ?>">
            <input type="hidden" name="user4" value="<?= $dataku["user4"]; ?>">
            <input type="hidden" name="user5" value="<?= $dataku["user5"]; ?>">
        </div>
    </div>
