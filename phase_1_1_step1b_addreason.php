...
<div class="w3-container w3-margin-top w3-large w3-mobile">
	...
	<div class="w3-row">
	  <div class="w3-col w3-container"><p>請寫下「為什麼」選擇它作為故事的中心點?想傳達什麼理念?或是故事想要解決什麼問題?以及故事是否帶給觀眾教育的價值?
	...
	<div class="container">
        <div class="comment">
            <textarea class="textinput" rows="10" placeholder="Add your reason here" type="text" name="nama"></textarea>
