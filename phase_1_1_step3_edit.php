...
$dataku = query("SELECT * FROM outline_desc WHERE id=$id")[0]; 
// var_dump($mhs[0]["nama"]);
...
<div class="w3-container w3-margin-top w3-large w3-mobile">
	...
	<div class="w3-row">
	  <div class="w3-col w3-container w3-xxlarge"><h1>階段一 - 步驟三: 修改我的大綱</h1></div>
	</div>
	<div class="w3-row">
	  <div class="w3-col w3-container"><p>你可以隨時修改自己的大綱
