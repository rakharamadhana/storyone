...
$theme = query("SELECT * FROM reflect2 WHERE user = '$userid'");
...
$userid = $_SESSION["userId"];
$query = "SELECT * FROM reflect2 WHERE user = '$userid' ORDER BY pilih ASC";
...
$(document).ready(function(){
 $( "#page_list" ).sortable({
  ...
  update  : function(event, ui)
  {
   ...
   $.ajax({
    url:"phase_3_1_step2_updateorder_flipped.php",
    method:"POST",
