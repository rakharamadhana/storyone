...
$theme = query("SELECT * FROM purpose_desc WHERE user = '$userid'");
...
$userid = $_SESSION["userId"];
$query = "SELECT * FROM purpose_desc WHERE user = '$userid' ORDER BY pilih ASC";
...
<div class="w3-container w3-margin-top w3-large w3-mobile">
	...
	<div class="w3-row">
	  <div class="w3-col w3-container w3-xxlarge"><h1>Phase 2 : Change purpose order now</a></h1></div>
	</div>
	<div class="w3-row"><br>
	  <div class="w3-col w3-container"><p>Pick one purpose, and drag to the first row as the best idea to explore</p></div>
	</div>
...
<div class="w3-row w3-center"><i class="fas fa-chevron-down w3-center" style="font-size: 30px;"></i></div>
    ...
    <a href="phase_1_1_step2.php" class="w3-button w3-section w3-green w3-ripple" style="text-decoration: none;">Back</a></div>
...
$(document).ready(function(){
 $( "#page_list" ).sortable({
  ...
  update  : function(event, ui)
  {
   ...
   $.ajax({
    url:"phase_1_1_step2_updateorder.php",
    method:"POST",
