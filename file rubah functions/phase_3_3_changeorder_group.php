...
$group = query("SELECT * FROM group_diss WHERE user = '$userid'");
...
$userid = $_SESSION["userId"];
$query = "SELECT * FROM group_diss WHERE user = '$userid' ORDER BY pilih ASC";
...
<div class="w3-container w3-margin-top w3-large w3-mobile">
	...
	<div class="w3-row">
	  <div class="w3-col w3-container w3-xxlarge"><h1>Phase 3 : Change group discussion order now</a></h1></div>
	</div>
	<div class="w3-row"><br>
	  <div class="w3-col w3-container"><p>Pick one discussion, and drag to the first row as the best idea to explore</p></div>
	</div>
...
$(document).ready(function(){
 $( "#page_list" ).sortable({
  ...
  update  : function(event, ui)
  {
   ...
   $.ajax({
    url:"phase_3_3_updateorder_group.php",
    method:"POST",
