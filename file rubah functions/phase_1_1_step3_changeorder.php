...
$outline = query("SELECT * FROM outline_desc WHERE user = '$userid'");
...
$userid = $_SESSION["userId"];
$query = "SELECT * FROM outline_desc WHERE user = '$userid' ORDER BY pilih ASC";
...
<div class="w3-container w3-margin-top w3-large w3-mobile">
	...
	<div class="w3-row">
	  <div class="w3-col w3-container w3-xxlarge"><h1>Phase 1 Step 3 : Change outline order now</a></h1></div>
	</div>
	<div class="w3-row"><br>
	  <div class="w3-col w3-container"><p>Pick one outline, and drag to the first row as the best idea to explore</p></div>
	</div>
...
<div class="w3-row w3-center"><i class="fas fa-chevron-down w3-center" style="font-size: 30px;"></i></div>
    ...
    <a href="phase_1_1_step3.php" class="w3-button w3-section w3-green w3-ripple" style="text-decoration: none;">Back</a></div>
...
$(document).ready(function(){
 $( "#page_list" ).sortable({
  ...
  update  : function(event, ui)
  {
   ...
   $.ajax({
    url:"phase_1_1_step3_updateorder.php",
    method:"POST",
