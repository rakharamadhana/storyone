...
<div class="w3-container w3-margin-top w3-large w3-mobile">
	...
	<div class="w3-row">
	  <div class="w3-col w3-container w3-xxlarge"><h1>階段一 步驟一 修改我的主題</h1></div>
	</div>
	<div class="w3-row">
	  <div class="w3-col w3-container"><p>你可以隨時修改自己的主題
	...
	<div class="container">
        <div class="comment">
            ...
            <textarea name="nama" class="textinput" rows="5" cols="10" wrap="hard" style="overflow:hidden; resize:none; margin-top:15px; overflow-y: scroll;"><?= $dataku["nama"]; ?></textarea>
