...
<?php foreach ( $outline as $row ) : ?>
	  ...
	  <div class="w3-col w3-container w3-quarter"><a href="phase_1_1_step3_edit.php?id=<?= $row["id"]; ?>" class="w3-button w3-section w3-green w3-ripple"><i class='fas fa-edit' style='font-size:24px'></i></a><a href="phase_1_1_step3_delete.php?id=<?= $row["id"]; ?>" onclick="return confirm('Do you want to delete?');" class="w3-button w3-section w3-green w3-ripple"><i class='fas fa-trash-alt' style='font-size:24px'></i></a></div>
	</div>
