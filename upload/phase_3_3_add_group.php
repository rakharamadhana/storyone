...
if ( isset($_POST["submit"]) ) {
  ...
  if ( tambahgroup($_POST) > 0 ) {
    echo "
      <script>
      alert('Your discussion has been added!');
    ...
    echo "
      <script>
      alert('Sorry, your discussion didn't added!');
      document.location.href = 'phase_3_3_group.php';
      </script>
    ";
  }
...
<div class="w3-container w3-margin-top w3-large w3-mobile">
	...
	<div class="w3-row">
	  <div class="w3-col w3-container w3-xxlarge"><h1>階段三：數位敘事作品的個人和小組反思內容</h1></div>
	</div>
	<div class="w3-row">
	  <div class="w3-col w3-container"><p>請點選「新增討論」，在「新增成員」區，加入組員的號碼後，你和小組成員即可在各自的帳號看到彼此寫得個人和小組作品的反思。  
	...
	<div>
        <div class="comment">
            <h3>Group name (隊名) :</h3> <input type="text" name="group_name" placeholder="Your group name">
            <textarea class="textinput" rows="10" placeholder="Add your new reflection here [ 請寫下小組作品共同反思的內容 ]
" type="text" name="nama" style="margin-top: 10px;"></textarea>
            <h3>Add members (新增成員) :</h3>
            成員二 : <input type="text" name="user2" style="margin-top: 10px;" placeholder="Enter the code"><br>
            成員三 : <input type="text" name="user3" style="margin-top: 10px;" placeholder="Enter the code"><br>
            成員四 : <input type="text" name="user4" style="margin-top: 10px;" placeholder="Enter the code"><br>
            成員五 : <input type="text" name="user5" style="margin-top: 10px;" placeholder="Enter the code">
        </div>
    </div>
