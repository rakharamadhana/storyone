...
<div class="w3-container w3-margin-top w3-large w3-mobile">
	...
	<div class="w3-row">
	  <div class="w3-col w3-container w3-xxlarge"><h1>數位敘事反思平台之討論室</h1></div>
	</div>
	<div class="w3-row">
	  <div class="w3-col w3-container"><p>你可以在此和班上同學或老師討論相關問題</p></div>
	</div>
	<div class="w3-row w3-lime">
	  <div class="w3-col w3-container w3-xxlarge">
	  	...
	  	<div style="margin-top: 15px;">
	  	<!-- <iframe src="chatting/example.php" style="border:none;width:100%;height:440px;"></iframe>--></div>
