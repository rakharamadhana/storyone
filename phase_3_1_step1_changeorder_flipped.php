...
$theme = query("SELECT * FROM reflect WHERE user = '$userid'");
...
$userid = $_SESSION["userId"];
$query = "SELECT * FROM reflect WHERE user = '$userid' ORDER BY pilih ASC";
...
$(document).ready(function(){
 $( "#page_list" ).sortable({
  ...
  update  : function(event, ui)
  {
   ...
   $.ajax({
    url:"phase_3_1_step1_updateorder_flipped.php",
    method:"POST",
