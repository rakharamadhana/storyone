...
$presentation = query("SELECT * FROM presentation WHERE user = '$userid' ORDER BY pilih ASC");
...
<div class="w3-container w3-margin-top w3-large w3-mobile">
	...
	<div class="w3-row">
	  <div class="w3-col w3-container w3-xxlarge"><h1>Phase 3 : Reflection of your presentation</a></h1></div>
	</div>
	<div class="w3-row">
	  <div class="w3-col w3-container"><p>This is the reflection of your presentation</p></div>
	</div>
...
<?php foreach ( $presentation as $row ) : ?>
	  ...
	  <div class="w3-col w3-container w3-quarter"><a href="phase_3_2_edit_present.php?id=<?= $row["id"]; ?>" class="w3-button w3-section w3-green w3-ripple"><i class='far fa-edit' style='font-size:24px'></i></a><a href="phase_3_2_delete_present.php?id=<?= $row["id"]; ?>" onclick="return confirm('Do you want to delete?');" class="w3-button w3-section w3-green w3-ripple"><i class='far fa-trash-alt' style='font-size:24px'></i></a></div>
	</div>
