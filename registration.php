...
<?php endif; ?>
	...
	<p>
	<label for="password2">Confirm Password (再次確認密碼)</label>
	<input class="w3-input" type="password" style="width:100%" name="password2" id="password2" required>
	</p>

	<p>
	<button type="submit" name="register" class="w3-button w3-section w3-green w3-ripple"> Register (註冊)</button>
	</p>
